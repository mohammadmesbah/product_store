                        ...
                        <div class="row">
                            <div class="col-lg-2">
                                <div class="details-image-vertical black-slide rounded">
                                    <div>
                                        <img src="{{asset('assets/images/fashion/product/front/'.$product->image_one)}}"
                                            class="img-fluid blur-up lazyload" alt="{{$product->name}}">
                                    </div>
                                @if ($product->image_two)
                                @php
                                    $related_images= explode(',',$product->image_two);
                                @endphp
                                    @foreach ($related_images as $image)
                                    <div>
                                        <img src="{{asset('assets/images/fashion/'.$image)}}"
                                            class="img-fluid blur-up lazyload" alt="{{$product->name}}">
                                    </div>
                                    @endforeach
                                @endif
                            ...
                            <div class="col-lg-10">
                                <div class="details-image-1 ratio_asos">
                                    <div>
                                        <img src="{{asset('assets/images/fashion/product/front/'.$product->image_one)}}" id="zoom_01"
                                ...
                                <div class="qty-box">
                                    <div class="input-group">
                                        <span class="input-group-prepend">
                                            <button type="button" class="btn quantity-left-minus" id="minus"
                                                onclick="" data-type="minus" data-field="">
                                        ...
                                        <span class="input-group-prepend">
                                            <button type="button" class="btn quantity-right-plus" id="plus"
                                                onclick="" data-type="plus" data-field="">
                    ...
                    <div class="product-box">
                        <div class="img-wrapper">
                            <div class="front">
                                <a href="{{route('products.show', $related_product->slug)}}">
                                    <img src="{{asset('assets/images/fashion/product/front/'.$related_product->image_one)}}"
                                        class="bg-img blur-up lazyload" alt="">
                                </a>
                            </div>
                            <div class="back">
                                <a href="{{route('products.show', $related_product->slug)}}">
                                    <img src="{{asset('assets/images/fashion/product/back/'.$related_product->image_two)}}"
                                        class="bg-img blur-up lazyload" alt="">
                                </a>
                            </div>
                            <div class="cart-wrap">
                        ...
                        <div class="product-details">
                            <div class="rating-details">
                                <span class="font-light grid-content">{{$related_product->name}}</span>
                            ...
                            <div class="main-price">
                                ...
                                <div class="listing-content">
                                    ...
                                    <p class="font-light">{{$related_product->short_description}}</p>
                                </div>
...
@endsection
@push('scripts')
<?php $qty= Cart::instance('cart')->qty; ?>
    <script>
