                                    ...
                                    <ul class="category-list">
                                        ...
                                        <li>
                                            <div class="form-check ps-0 custome-form-check">
                                                <input class="checkbox_animated check-it" id="brand_{{$brand->id}}" name="brands"
                                                    value="{{$brand->id}}" type="checkbox"
                                                    @if (in_array($brand->id, explode(',',$qBrand))) checked="checked" @endif 
                            ...
                            <div id="collapseFour" class="accordion-collapse collapse show"
                                ...
                                <div class="accordion-body">
                                    <div class="range-slider category-list">
                                        ...
                                        <p class="text-center text-secondary">{{'price: From  '.$from .' EGP - To '.$to.' EGP'}}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    @foreach ($categories as $category)
                                        ...
                                        <li>
                                            <div class="form-check ps-0 custome-form-check">
                                                ...
                                                @if (in_array($category->id, explode(',',$qCategory))) checked="checked" @endif
                            ...
                            <div class="img-wrapper">
                                <div class="front">
                                    <a href="{{route('products.show', $product->slug)}}">
                                        <img src="assets/images/fashion/product/front/{{$product->image_one}}"
                                            class="bg-img blur-up lazyload" alt="">
                                    </a>
                                </div>
                                <div class="back">
                                    <a href="{{route('products.show',$product->slug)}}">
                                        <img src="assets/images/fashion/product/back/{{$product->image_two}}"
                                            class="bg-img blur-up lazyload" alt="">
                                    </a>
                                </div>
                                <div class="cart-wrap">
...
<form id="formFilter" method="get">
    ...
    <input type="hidden" name="brand" id="brand" value="{{$qBrand}}">
    <input type="hidden" name="category" id="category" value="{{$qCategory}}">
    <input type="hidden" name="pricerange" id="prange" value="">
</form>
...
<script>
   $(function() {
    ...
    function cartCountAndWishlistCount(){
        $.ajax({
            url: "{{route('shop.cartCountAndWishlistCount')}}",
            type: "GET",
            success: function (data) {
                if(data.status == 200){
